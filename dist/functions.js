...
function applyColumnTypes(rows, columnTypeMap) {
  var startRow = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
  var entries = Object.entries(columnTypeMap).map(function (_ref) {
...
function sanitize(rows) {
  function sanitizeCell(v) {
    ...
    var coercedDate = coerceValueType(v, "date");
  ...
  _FREE_FLOAT = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(subSector) {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        ...
        case 1:
          data = _context4.v;
          rows = [["Symbol", "Company Name", "Free Float %"]].concat(_toConsumableArray(data.map(function (c) {
            return [c.symbol, c.company_name, c.free_float];
          })));
          applyColumnTypes(rows, {
            2: "number"
          });
          return _context4.a(2, sanitize(rows));
        case 2:
          _context4.p = 2;
          _t3 = _context4.v;
    ...
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        ...
        case 1:
          ...
          return _context5.a(2, sanitize(rows));
        case 2:
          _context5.p = 2;
          _t4 = _context5.v;
    ...
    return _regenerator().w(function (_context0) {
      while (1) switch (_context0.p = _context0.n) {
        ...
        case 1:
          d = _context0.v;
          s = d.statistics;
          rows = [["Total Companies", s.total_companies], ["Filtered Median PE", s.filtered_median_pe], ["Filtered Weighted Avg PE", s.filtered_weighted_avg_pe], ["Min Company PE", s.min_company_pe], ["Max Company PE", s.max_company_pe]];
          applyKeyValueTypes(rows, {
          ...
          return _context0.a(2, sanitize(rows));
        case 2:
          _context0.p = 2;
          _t9 = _context0.v;
...
function _SUBSECTOR_MARKET_CAP() {
  _SUBSECTOR_MARKET_CAP = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1(subSector) {
    var _m$mcap_summary, _m$mcap_summary2, _m$mcap_summary3, d, m, rows, _t0;
    return _regenerator().w(function (_context1) {
      while (1) switch (_context1.p = _context1.n) {
        ...
        case 1:
          ...
          return _context1.a(2, sanitize(rows));
        case 2:
          _context1.p = 2;
          _t0 = _context1.v;
  ...
  _IPO_PERFORMANCE = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee19(ticker) {
    ...
    return _regenerator().w(function (_context22) {
      while (1) switch (_context22.p = _context22.n) {
        ...
        case 1:
          d = _context22.v;
          rows = [["Period", "Change"], ["7 Days", d.chg_7d], ["30 Days", d.chg_30d], ["90 Days", d.chg_90d], ["365 Days", d.chg_365d]];
          applyColumnTypes(rows, {
            1: "number"
          });
          return _context22.a(2, sanitize(rows));
        case 2:
          _context22.p = 2;
          _t18 = _context22.v;
            ...
            return _regenerator().w(function (_context25) {
              while (1) switch (_context25.n) {
                case 0:
                  ...
                  stocks.forEach(function (s) {
                    var _ref3, _s$cls;
                    var val = (_ref3 = (_s$cls = s[cls]) !== null && _s$cls !== void 0 ? _s$cls : s.forward_dividend_yield) !== null && _ref3 !== void 0 ? _ref3 : "";
    ...
    return _regenerator().w(function (_context27) {
      while (1) switch (_context27.p = _context27.n) {
        ...
        case 1:
          d = _context27.v;
          o = d.overview;
          rows = [["Name", d.name], ["Market Cap", o.market_cap], ["Sector", o.sector], ["Sub Sector", o.sub_sector], ["Volume", o.volume], ["1D Change", o.change_1d], ["7D Change", o.change_7d]];
          applyKeyValueTypes(rows, {
            "Market Cap": "number",
            Volume: "number",
            "1D Change": "number",
          ...
          return _context27.a(2, sanitize(rows));
        case 2:
          _context27.p = 2;
          _t22 = _context27.v;
    ...
    return _regenerator().w(function (_context28) {
      while (1) switch (_context28.p = _context28.n) {
        ...
        case 1:
          d = _context28.v;
          v = d.valuation;
          rows = [["PE", v.pe], ["PE TTM", v.pe_ttm], ["PB", v.pb], ["PS TTM", v.ps_ttm], ["PCF", v.pcf], ["PCF TTM", v.pcf_ttm]];
          applyKeyValueTypes(rows, {
            PE: "number",
            "PE TTM": "number",
            PB: "number",
          ...
          return _context28.a(2, sanitize(rows));
        case 2:
          _context28.p = 2;
          _t23 = _context28.v;
    ...
    return _regenerator().w(function (_context30) {
      while (1) switch (_context30.p = _context30.n) {
        ...
        case 1:
          d = _context30.v;
          div = d.dividend;
          rows = [["5Y Avg Yield", div.dividend_yield_5y_avg], ["Growth Rate", div.dividend_growth_rate], ["Payout Ratio", div.payout_ratio], ["Forward Dividend", div.forward_dividend], ["Forward Div Yield", div.forward_dividend_yield], ["Dividend TTM", div.dividend_ttm]];
          applyKeyValueTypes(rows, {
            "5Y Avg Yield": "number",
            "Growth Rate": "number",
            "Payout Ratio": "number",
          ...
          return _context30.a(2, sanitize(rows));
        case 2:
          _context30.p = 2;
          _t25 = _context30.v;
            ...
            return _regenerator().w(function (_context33) {
              while (1) switch (_context33.n) {
                case 0:
                  ...
                  stocks.forEach(function (s) {
                    var _ref4, _s$cls2;
                    var val = (_ref4 = (_s$cls2 = s[cls]) !== null && _s$cls2 !== void 0 ? _s$cls2 : s.forward_dividend_yield) !== null && _ref4 !== void 0 ? _ref4 : "";
                    rows.push([cls, s.symbol, s.company_name, val]);
                  });
                case 1:
    ...
    return _regenerator().w(function (_context35) {
      while (1) switch (_context35.p = _context35.n) {
        ...
        case 1:
          d = _context35.v;
          o = d.overview;
          rows = [["Name", d.name], ["Market Cap", o.market_cap], ["Sector", o.sector], ["Sub Sector", o.sub_sector], ["Volume", o.volume], ["1D Change", o.change_1d], ["7D Change", o.change_7d], ["1M Change", o.change_1m], ["1Y Change", o.change_1y], ["YTD Change", o.change_ytd]];
          applyKeyValueTypes(rows, {
            "Market Cap": "number",
            Volume: "number",
            "1D Change": "number",
          ...
          return _context35.a(2, sanitize(rows));
        case 2:
          _context35.p = 2;
          _t29 = _context35.v;
    ...
    return _regenerator().w(function (_context36) {
      while (1) switch (_context36.p = _context36.n) {
        ...
        case 1:
          d = _context36.v;
          v = d.valuation;
          rows = [["PE", v.pe], ["PB", v.pb], ["PS", v.ps], ["PCF", v.pcf]];
          applyKeyValueTypes(rows, {
            PE: "number",
            PB: "number",
            PS: "number",
          ...
          return _context36.a(2, sanitize(rows));
        case 2:
          _context36.p = 2;
          _t30 = _context36.v;
